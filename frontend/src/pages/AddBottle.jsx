...
const INITIAL = { name: "", vintage: "", type: "Red", region: "", producer: "", quantity: 1, purchasePrice: "", currentOwner: "", description: "" };
...
export default function AddBottle({ onNavigate }) {
  ...
  const handleSubmit = async () => {
    if (!form.name || !form.vintage || !form.region || !form.producer || !form.currentOwner) {
  ...
  return (
    <div>
      ...
      {lastBlock && (
        <div className="card">
          <div className="card-title" style={{ color: "#1e7a40" }}>✓ Block mined successfully</div>
